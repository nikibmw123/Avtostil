...
namespace ASP_Avto_Stil.Controllers
{
    public class BrandModelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Brand,Model,Description,RegisterOn")] BrandModel brandModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Brand,Model,Description,RegisterOn")] BrandModel brandModel)
        {
            if (id != brandModel.Id)
            {
                return NotFound();
